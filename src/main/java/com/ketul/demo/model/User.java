...
//	public User(int uid, String role, String fname, String lname, String email, String pass) {
//		super();
//		this.uid = uid;
//		this.role = role;
//		this.fname = fname;
...
//		return "User [uid=" + uid + ", role=" + role + ", fname=" + fname + ", lname=" + lname + ", email=" + email
//				+ ", pass=" + pass + ", age=" + age + ", gender=" + gender + ", bloodgroup=" + bloodgroup + ", number="
//				+ number + ", degree=" + degree + ", spacialization=" + spacialization + ", experience=" + experience
//				+ ", nclinic=" + nclinic + ", aclinic=" + aclinic + ", profile=" + profile + "]";
//	}
//	@Override
//	public String toString() {
//		return "User [uid=" + uid + ", role=" + role + ", fname=" + fname + ", lname=" + lname + ", email=" + email
...
//	}
	...
	@Override
	public String toString() {
		return "User [uid=" + uid + ", role=" + role + ", email=" + email + ", pass=" + pass + "]";
	}	
